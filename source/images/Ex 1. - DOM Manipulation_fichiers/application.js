...
function run_challenges() {
  ...
  var email = $('[type=text]').val();  // TODO: replace null, keep the email variable.


  // Ex 2. Fill the content of the email input with your email
$('[type=text]').val("thibault.finot@gmail.com");
...
$('tbody').append('<tr><td>15</td><td>Stade Phelix Bolaert</td><td>0</td></tr>');
...
sum += parseInt($('td:last-child').first().text());
})
